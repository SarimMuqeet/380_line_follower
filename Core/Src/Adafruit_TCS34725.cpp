...
//void Adafruit_TCS34725::write8(I2C_HandleTypeDef *hi2c, uint8_t reg, uint32_t value) {
//    uint8_t data =value & 0xFF;
//    if(HAL_I2C_Mem_Write(hi2c, (uint16_t)_i2caddr<<1, TCS34725_COMMAND_BIT | reg, 1, &data, 1, 100) != HAL_OK){
//        while(1);
//    }
//}
...
//uint8_t Adafruit_TCS34725::read8(I2C_HandleTypeDef *hi2c, uint8_t reg) {
//    uint8_t data =0;
//    if(HAL_I2C_Mem_Read(hi2c, (uint16_t)_i2caddr<<1, TCS34725_COMMAND_BIT | reg, 1, &data, 1, 100) != HAL_OK){
//        while(1);
//    }
//    return data;
//}
 ...
 *  @return True if initialization was successful, otherwise false.
 */
bool Adafruit_TCS34725::begin(uint8_t addr, I2C_HandleTypeDef *hi2c) {
  _i2caddr = addr;
  _hi2c = hi2c;
